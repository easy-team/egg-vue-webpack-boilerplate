...
- Egg + TypeScript 已初步支持， 包括 Node 端 typescript 编写 和 前端 TypeScript编写, 具体请见 [typescript] 分支(https://github.com/hubcarl/egg-vue-webpack-boilerplate/tree/typescript) 分支
